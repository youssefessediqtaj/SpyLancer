...
export declare class MeiliSearch {
     ...
     * @experimental
     */
    updateNetwork(options: UpdatableNetwork): Promise<Network>;
    /**
     * Get all API keys
     *
     * @param parameters - Parameters to browse the indexes
