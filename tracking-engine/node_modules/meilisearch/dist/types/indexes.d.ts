...
export declare class Index<T extends RecordAny = RecordAny> {
     ...
     * @returns Promise containing an EnqueuedTask
     */
    deleteDocuments(params: DocumentsDeletionQuery | DocumentsIds): EnqueuedTaskPromise;
    /**
     ...
     * @returns Promise containing an EnqueuedTask
     */
    updateDocumentsByFunction(options: UpdateDocumentsByFunctionOptions): EnqueuedTaskPromise;
    /**
